...
class MediaTextReveal extends Piece {
	...
	#inset: { top: number; right: number; bottom: number; left: number } | null = null;
	#scrollTrigger: ScrollTrigger | null = null;
	#mm: ReturnType<typeof gsap.matchMedia> | null = null;
	#resizeObserver: ResizeObserver | null = null;
	#layoutRaf: number | null = null;
	...
	#getPercentages($mask: HTMLElement): {
		top: number;
		right: number;
		bottom: number;
		left: number;
