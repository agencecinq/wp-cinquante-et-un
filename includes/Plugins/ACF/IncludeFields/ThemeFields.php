			...
			array(
				...
				'sub_fields' => array(
					...
					array(
						...
						'sub_fields' => array(
							array(
								'key'          => 'field_' . $key . '_theme_footer_tagline',
								'label'        => __( 'Tagline', 'wp-cinquante-et-un' ),
								'name'         => 'tagline',
								'aria-label'   => __( 'Tagline', 'wp-cinquante-et-un' ),
								'type'         => 'textarea',
								'rows'         => 2,
								'placeholder'  => __( 'Tagline', 'wp-cinquante-et-un' ),
								'instructions' => __( 'Short sentence displayed next to the logo in the footer.', 'wp-cinquante-et-un' ) . ' <em>(' . __( 'Optional', 'wp-cinquante-et-un' ) . ')</em>.',
							),
							array(
								'key'          => 'field_' . $key . '_theme_footer_locations',
								...
								'instructions' => __( 'Cities or locations shown in the footer brand column.', 'wp-cinquante-et-un' ) . ' <em>(' . __( 'Optional', 'wp-cinquante-et-un' ) . ')</em>.',
							),
						),
					),
					array(
					...
					array(
						...
						'sub_fields' => array(
							...
							array(
								...
								'instructions' => __( 'Displayed in the footer brand column.', 'wp-cinquante-et-un' ) . ' <em>(' . __( 'Optional', 'wp-cinquante-et-un' ) . ')</em>.',
							),
							array(
