 ...
 *
 * Loads advanced custom fields for the taxonomy product category options.
 */
class TaxonomyProductCatFields implements Service {

	/**
	 * Layout classes for the taxonomy product category blocks. Order = display order.
	...
	public function fields(): void {
		...
		$fields = array(
			array(
				'key'        => 'field_' . $key,
				'label'      => __( 'Taxonomy Product Category', 'nexiode' ),
				'name'       => 'taxonomy_product_cat',
				'aria-label' => __( 'Taxonomy Product Category', 'nexiode' ),
				'type'       => 'group',
				'layout'     => 'block',
				'sub_fields' => array(
					array(
						...
						'sub_fields' => array(
							array(
								...
								'instructions' => __( 'Main heading for the taxonomy product category hero.', 'nexiode' ),
							),
							array(
							...
							array(
								...
								'sub_fields'   => array(
									array(
										'key'        => 'field_' . $key . '_hero_links_link',
		...
		if ( function_exists( 'acf_add_local_field_group' ) ) {
			acf_add_local_field_group(
				array(
					'key'      => 'group_' . $key,
					'title'    => __( 'Taxonomy Product Category', 'nexiode' ),
					'fields'   => $fields,
					'location' => $location,
				)
			);
