	...
	public function fields() {
		...
		$fields = array(
			...
			array(
				...
				'type'          => 'select',
				'choices'       => array(
					'title-3xl' => __( 'Title 3XL', 'wp-cinquante-et-un' ),
					'title-xxl' => __( 'Title XXL', 'wp-cinquante-et-un' ),
					'title-xl'  => __( 'Title XL', 'wp-cinquante-et-un' ),
					'title-lg'  => __( 'Title LG', 'wp-cinquante-et-un' ),
					'title-md'  => __( 'Title MD', 'wp-cinquante-et-un' ),
				),
				'default_value' => 'title-xl',
				'return_format' => 'value',
			),
			array(
